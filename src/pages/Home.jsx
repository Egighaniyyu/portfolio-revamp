    ...
    <>
      ...
      <div className="container">
        <div className="sec-jumbotron relative">
          <div className="flex flex-col items-start">
            <div className="header-title">FROM IDEA</div>
            <div className="header-title">TO AWESOME</div>
          </div>
      ...
      <div className="inline-flex flex-col justify-center items-center gap-10 mt-section w-full">
        <div className="flex items-center gap-12">
          <div className="text-quote">MAKE AMAZING</div>
          <img src={Quotes1} alt="quotes1" />
        </div>
        <div className="flex items-center gap-12">
          <img src={Quotes2} alt="quotes2" />
          <div className="text-quote">IDEAS FOR YOU</div>
        </div>
      </div>
      {/* end quote */}
